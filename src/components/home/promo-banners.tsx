    ...
    <section className="py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* COVID-19 Banner */}
          <div className="relative rounded-2xl overflow-hidden bg-accent/20 min-h-[280px]">
            <Image
          ...
          {/* Home Medical Banner */}
          <div className="relative rounded-2xl overflow-hidden bg-primary/20 min-h-[280px]">
            <Image
            ...
            <div className="absolute inset-0 flex flex-col justify-center p-8">
              ...
              <p className="text-background/80 text-lg mb-4">$45.00 - $55.00</p>
